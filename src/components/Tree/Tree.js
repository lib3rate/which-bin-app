...
const Tree = (props) => {
  ...
  let startingFullTreeNumber = 0;
  let endingBaseNumber = 0;
  let endingBaseLeavesNumber = 0;
  let endingAlmostTreeNumber = 0;
  let endingFullTreeNumber = 0;
  let baseRender = 0;
  ...
  return (
    <StyledTree
      ...
      startingAlmostTreeNumber={startingAlmostTreeNumber}
      startingFullTreeNumber={startingFullTreeNumber}
      endingBaseNumber={endingBaseNumber}
      endingBaseLeavesNumber={endingBaseLeavesNumber}
      endingAlmostTreeNumber={endingAlmostTreeNumber}
      endingFullTreeNumber={endingFullTreeNumber}
...
const StyledTree = styled.svg`
  #almostTree, #fullTree, #baseLeaves, #base {
    ${{ ...branchStyle }}
  }
  #base {
    animation: base ${(props) => props.treeDuration} forwards;
    opacity: ${(props) => props.baseRender};
    
  }
  #baseLeaves {
    animation: baseLeaves ${(props) => props.treeDuration} forwards;
    opacity: ${(props) => props.baseLeavesRender};
  }
  #almostTree {
    animation: almostTree ${(props) => props.treeDuration} forwards;
    opacity: ${(props) => props.almostTreeRender};
  }
  #fullTree {
    animation: fullTree ${(props) => props.treeDuration} forwards;
  ...
  @keyframes almostTree {
    0% {
      stroke-dashoffset: ${(props) => props.startingAlmostTreeNumber};
    }
    100% {
      stroke-dashoffset: ${(props) => props.endingAlmostTreeNumber};
    }
  }
  @keyframes fullTree {
    0% {
      stroke-dashoffset: ${(props) => props.startingFullTreeNumber};
    }
    100% {
      stroke-dashoffset: ${(props) => props.endingFullTreeNumber};
    }
  }
`;
