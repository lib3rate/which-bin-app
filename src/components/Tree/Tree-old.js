...
// works with material ui but no props passed--------------------->
...
// not worked using material ui------------------------>
// const useStyles = makeStyles((treeTotal) =>
//   ({
//   "@keyframes base": {
//     from: { strokeDashoffset: (treeTotal) =>  treeTotal },
//     // from: { strokeDashoffset:  treeTotal.treeTotal },
...
const Tree = ({ treeTotal }) => { 
  ...
  return (
  <StyledTree treeTotal={treeTotal}>
        <svg
      id="Layer_1"
      data-name="Layer 1"
...
to: { strokeDashoffset: 0 },
`
// const baseLeaves = keyframes`
// from: { strokeDashoffset: 1000 },
// to: { strokeDashoffset: 0 },
// `
// const rightBrance = keyframes`
// from: { strokeDashoffset: 1000 },
// to: { strokeDashoffset: 0 },
// `
// const leftBrance = keyframes`
// from: { strokeDashoffset: 1000 },
// to: { strokeDashoffset: 0 },
// `
...
//   // const treeSize = 1000
//   const treeSize = props.treeTotal
//   const classes = useStyles(treeSize)
